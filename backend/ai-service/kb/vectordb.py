...
class VectorDBClient:
    def __init__(self, persist_directory: str = "./chroma_db", api_key: Optional[str] = None):
        ...
        :param api_key: Gemini API key. If not provided, it will try to read from the GEMINI_API_KEY env var.
        """
    ...
    def roll_forward_commit(self, repo: str, branch: str, old_commit_hash: str, new_commit_hash: str):
        ...
        from old_commit_hash to new_commit_hash. This automatically handles staleness for unchanged files.
        """
    ...
    def delete_stale_entries(self, repo: str, branch: str, latest_commit_hash: str):
        ...
        This handles the case where files or symbols were deleted in the latest commit,
        assuming roll_forward_commit was called on all unchanged files.
        """
    ...
    def query(
        ...
        :param query_texts: List of strings to search for.
        :param n_results: Number of results to return.
        :param where: Optional metadata filter (e.g., {"repo": "user/repo", "content_type": "code"}).
        :return: ChromaDB query results containing documents, distances, and metadatas.
        """
